...
def get_arguments(argv):
    ...
    parser.add_argument('-b', '--big_network', action='store_true', default=False,
                        help='show debug messages')
...
def main():
    ...
    if args.max_n_examples:
        X_train = X_train[:args.max_n_examples, :]
        y_train = y_train[:args.max_n_examples]
